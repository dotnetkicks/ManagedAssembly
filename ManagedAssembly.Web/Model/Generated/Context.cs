...
{
    public partial class ManagedAssemblyDB : IQuerySurface
    {
        ...
        public ManagedAssemblyDB() 
        { 
            DataProvider = ProviderFactory.GetProvider("ManagedAssembly");
            Init();
        }

        public ManagedAssemblyDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public ManagedAssemblyDB(string connectionString, string providerName)
        {
        ...
        public Query<PostTag> PostTags { get; set; }
        public Query<Vote> Votes { get; set; }
        public Query<VoteDirection> VoteDirections { get; set; }
        ...
        void Init()
        {
            ...
            PostTags = new Query<PostTag>(provider);
            Votes = new Query<Vote>(provider);
            VoteDirections = new Query<VoteDirection>(provider);
        	...
        	if(DataProvider.Schema.Tables.Count == 0)
			{
            	...
            	DataProvider.Schema.Tables.Add(new PostTagTable(DataProvider));
            	DataProvider.Schema.Tables.Add(new VoteTable(DataProvider));
            	DataProvider.Schema.Tables.Add(new VoteDirectionTable(DataProvider));
            	DataProvider.Schema.Tables.Add(new UserTable(DataProvider));
            	DataProvider.Schema.Tables.Add(new PostTable(DataProvider));
            }
            #endregion
        }
    }
